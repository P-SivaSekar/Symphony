...
class _MiniPlayerContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (song.coverUrl.isEmpty) {
      ...
      image = Image.file(File(song.coverUrl.replaceFirst('file://', '')), fit: BoxFit.cover, errorBuilder: (_,__,___) => Container(color: Colors.black12, child: const Icon(Icons.music_note, size: 20)));
    } else {
